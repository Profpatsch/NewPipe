...
class VideoDetailFragment :
    ...
    private fun isFullscreen(): Boolean {
        return isPlayerAvailable() && player!!.UIs()
            ...
            .map<Boolean?>(Function { obj: VideoPlayerUi? -> obj!!.isFullscreen() }).orElse(false)
    }
    ...
    private fun showExternalVideoPlaybackDialog() {
        ...
        if (videoStreamsForExternalPlayers.isEmpty()) {
            ...
            builder.setSingleChoiceItems(
                resolutions, selectedVideoStreamIndexForExternalPlayers, { dialog: DialogInterface?, i: Int -> {} }
            )
    ...
    private fun showExternalAudioPlaybackDialog() {
        ...
        if (audioTracks.isEmpty()) {
            ...
            val trackNames: Array<CharSequence> = audioTracks
